    ...
    for i, file_name in enumerate(fixture_files, 1):
        ...
        with patch(
            ...
            with patch(
                ...
                print(
                    f"[{i}/{total_logs}] Evaluating {file_name} (Expected: {expected_category})... ",
                    end="",
                    flush=True,
                )
                ...
                print(
                    f"Predicted: {predicted_category} | Confidence: {confidence:.2f} | Time: {elapsed:.2f}s"
                )
