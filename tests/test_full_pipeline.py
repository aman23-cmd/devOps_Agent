...
from api.webhook_receiver import app, _get_redis
from config.settings import get_settings
from api.models import PipelineFailureEvent, DiagnosisResult, FixProposal, RiskLevel, RootCauseCategory
from agents.worker import AgentWorker
from db.fix_history import FixHistoryRecord, get_session
...
async def test_worker_process_event_integration(mock_get_session, mock_slack_class, mock_gen_fixes, mock_diagnosis):
